...
## [25.0.0](https://github.com/Wollac/revm/compare/revm-precompile-v24.0.1...revm-precompile-v25.0.0) - 2025-07-21

### Added

- *(precompiles)* Use bytes API for underlying precompile library APIs ([#2705](https://github.com/Wollac/revm/pull/2705))
- *(precompile)* update osaka modexp gas divisor ([#2740](https://github.com/Wollac/revm/pull/2740))
- *(precompile)* update p256 verify osaka gas cost ([#2741](https://github.com/Wollac/revm/pull/2741))
- add a way for precompiles to revert ([#2711](https://github.com/Wollac/revm/pull/2711))

### Other

- *(precompile)* refactor blake2 input parsing ([#2734](https://github.com/Wollac/revm/pull/2734))
- Add blake2 benchmarks ([#2735](https://github.com/Wollac/revm/pull/2735))
- add asm-sha2 feature for sha2 precompile ([#2712](https://github.com/Wollac/revm/pull/2712))
