...
## [7.0.2](https://github.com/Wollac/revm/compare/revm-database-interface-v7.0.1...revm-database-interface-v7.0.2) - 2025-07-21

### Other

- impl DatabaseRef for WrapDatabaseRef ([#2726](https://github.com/Wollac/revm/pull/2726))
