...
## [9.1.0](https://github.com/Wollac/revm/compare/revm-bytecode-v9.0.0...revm-bytecode-v9.1.0) - 2026-03-18
...
- make Bytecode Ord consistent with PartialEq and Hash ([#3479](https://github.com/Wollac/revm/pull/3479))
