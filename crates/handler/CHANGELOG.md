...
## [8.1.0](https://github.com/Wollac/revm/compare/revm-handler-v8.0.3...revm-handler-v8.1.0) - 2025-07-21
...
- gas deduction with `disable_balance_check` ([#2699](https://github.com/Wollac/revm/pull/2699))

### Other

- change gas parameter to immutable reference ([#2702](https://github.com/Wollac/revm/pull/2702))
- remove State bound from JournalTr in Handler::Evm ([#2715](https://github.com/Wollac/revm/pull/2715))
