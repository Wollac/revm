...
## [8.1.0](https://github.com/Wollac/revm/compare/revm-inspector-v8.0.3...revm-inspector-v8.1.0) - 2025-07-18

### Added

- count inspector and bench test ([#2730](https://github.com/Wollac/revm/pull/2730))

### Other

- *(inspector)* simplify create_end docs and intrp.bytecode.set_action ([#2723](https://github.com/Wollac/revm/pull/2723))
- *(inspector)* update obsolete current_opcode() comment ([#2722](https://github.com/Wollac/revm/pull/2722))
