...
## [24.0.0](https://github.com/Wollac/revm/compare/revm-interpreter-v23.0.2...revm-interpreter-v24.0.0) - 2025-07-21

### Added

- *(interpreter)* update CLZ cost ([#2739](https://github.com/Wollac/revm/pull/2739))

### Other

- discard generic host implementation ([#2738](https://github.com/Wollac/revm/pull/2738))
- add release safety section for SharedMemory fn ([#2718](https://github.com/Wollac/revm/pull/2718))
- *(interpreter)* update docs for slice_mut and slice_range ([#2714](https://github.com/Wollac/revm/pull/2714))
